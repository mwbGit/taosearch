...
<script src="${ctx }/static/js/_xzgl.js"></script>
...
<div class="col-xs-12 col-sm-12 col-md-12">
			<button class="btn btn-success book_theme_flag2" type="button" data-toggle="modal"
				data-target="#addBooks" onclick="showAddTeamModel()"> 
 				<i class="glyphicon glyphicon-plus"></i>新增小组
			</button> 
			<div style="float:right"><a href="#" onclick="skipUserList()"><i class="glyphicon glyphicon-hand-right"></i>用户管理</a></div>
