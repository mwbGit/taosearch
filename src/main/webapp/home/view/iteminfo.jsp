			...
			<form class=" col-xs-12 col-sm-12 col-md-12" id="item_info_form" role="form">
				...
				<table style="width: 90%; border-collapse: separate; border-spacing: 20px;">
					...
					<tr>
						<td></td>
						<td>优惠券有效期：</td>
						<td><input id="itemInfo_coupon_start_time_id" name="coupon_start_time" style="width: 11%; border-style: none; background-color: #fff; cursor: default;" readonly="readonly">- <input id="itemInfo_coupon_end_time_id" name="coupon_end_time" style="width: 11%; border-style: none; background-color: #fff; cursor: default;" readonly="readonly"></td>
					</tr>
					<tr>
						<td><input type="button" onClick="copyText1(this)" value="点击复制" /></td>
						<td>备注信息：</td>
