...
$(function(){
		$(".book_theme_flag1").show();
		$(".book_theme_flag2").hide();
})
function book_theme_flag1(){
	$('#bookThemedropdownMenu').html("列表模式");
	$('#book_theme_flag').val(1);
	$(".book_theme_flag1").show();
	$(".book_theme_flag2").hide();
}
function book_theme_flag2(){
	$('#bookThemedropdownMenu').html("图片模式");
	$('#book_theme_flag').val(2);
	$(".book_theme_flag2").show();
	$(".book_theme_flag1").hide();
}

</script>
<script src="${ctx }/static/js/_syjc.js"></script>
